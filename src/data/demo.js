export const demoSystemData = {
  ...
  programmes: [
    {
      ...
      work: [
        'Own and maintain the Dublin Campus Integrated Master Schedule (IMS) across multiple GCs and workstreams',
        'Run schedule health checks (DCMA/QSRA), logic corrections, float path reviews and mitigation workshops',
        'Support EOT / change impact assessments and provide schedule narratives for stakeholder alignment',
        'Drive power strategy planning (temporary vs permanent), commissioning readiness and RFS gating',
        'Produce leadership-ready reporting packs: progress KPIs, risk registers, and scenario forecasts'
      ],
      workstreams: [
      ...
      decisions: [
        ...
        {
          id: 'd2',
          title: 'POWER STRATEGY PIVOT',
          date: '2025-08',
          project: 'MFGP (Power Strategy)',
          context: 'AVK engine lead times shifted',
          intervention: 'TGF/MFGP sequencing',
          impact: 'Stabilised critical path',
          counterfactual: '41 days slip',
          metrics: { daysRecovered: 18 }
        },
        {
          id: 'd3',
          title: 'EOT PACKAGE STRUCTURE',
          date: '2025-10',
          project: 'Contract (EOT / Claims)',
          context: 'Overlapping delay narratives',
          intervention: 'Segmented EOT2-5 + evidence map',
          impact: 'Clear causation story',
          counterfactual: 'Weak entitlement',
          metrics: { riskReduced: 0.2 }
        }
      ],
      work: [
        'Owned MEP contractor programmes and aligned multi-project reporting across sectors',
        'Built baselines, managed update cycles, analysed variances and produced stakeholder narratives',
        'Developed 4D / commissioning-ready sequences and constraint log / lookahead planning',
        'Led schedule health checks, change control, and mitigation workshops with PM/Construction teams'
      ],
      workstreams: [
    ...
    },
    {
      ...
      work: [
        'Managed end-to-end planning for a 2-building hyperscale DC campus (baseline → delivery)',
        'Implemented schedule governance: change control, reporting cadence, and KPI dashboards',
        'Supported commissioning readiness, handover tracking and stakeholder communications'
      ],
      workstreams: [
        { id: 'design', name: 'DESIGN', progress: 100 },
        { id: 'procurement', name: 'PROCUREMENT', progress: 100 },
    ...
    },
    {
      ...
      work: [
        'Built and maintained detailed MEP programmes for multi-country delivery and commissioning',
        'Produced schedule logic integrity checks, lookaheads and constraint plans for site teams',
        'Supported commercial reporting, progress measurement and stakeholder communication packs'
      ],
      workstreams: [
        { id: 'design', name: 'DESIGN', progress: 100 },
        { id: 'procurement', name: 'PROCUREMENT', progress: 100 },
  ...
  locations: [
    ...
    { id: 'dublin-hospital', name: 'Dublin (Mercury) – Hospital', lat: 53.35, lng: -6.26, capacity: 'Project', status: 'completed', type: 'Hospital' },
    { id: 'drogheda', name: 'Drogheda (JPC)', lat: 53.72, lng: -6.35, capacity: '96MW', status: 'completed', type: 'Data Centre' },
    { id: 'limerick-pharma', name: 'Limerick (JPC) – Pharma', lat: 52.66, lng: -8.62, capacity: 'Project', status: 'completed', type: 'Pharma' },
    { id: 'cork-pharma', name: 'Cork (JPC) – Pharma', lat: 51.9, lng: -8.47, capacity: 'Project', status: 'completed', type: 'Pharma' },
    { id: 'dundalk-pharma', name: 'Dundalk (Mercury) – Pharma', lat: 54.0, lng: -6.4, capacity: 'Project', status: 'completed', type: 'Pharma' },
