    ...
    <div style={{ padding: 24, fontFamily: 'monospace' }}>
      ...
      <div style={{ marginTop: 20, padding: 18, background: c.bg.card, border: '1px solid ' + c.border.default }}>
        <p style={{ fontSize: 10, color: c.text.secondary, lineHeight: 1.6, margin: 0 }}>
          This section is intentionally lightweight in this demo build. If you want, I can expand it into a full interactive
          timeline (companies, project highlights, quantified impacts, links to work samples) and keep a separate “Public / Client-safe” profile view.
        </p>
      </div>
    </div>
  );
