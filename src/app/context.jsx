...
export function AppProvider({ children }) {
  ...
  const value = useMemo(
    ...
    [section, mode, scenario, programme, decision, demoMode, privacyMode, uploadedFile, dataDate, analysis, comparison, riskRegister, playbook, actionPlan, isAdmin, toolsTab]
  );
