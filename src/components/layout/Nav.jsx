...
import { Activity, TrendingUp, Layers, GitBranch, Globe, Target, Settings, Briefcase, Clock, MessageSquare, Bot } from 'lucide-react';
...
const sections = [
  ...
  { id: 'assistant', label: "ANIKET'S AI ASSISTANT", icon: Bot },
